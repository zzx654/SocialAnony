...
import com.example.appportfolio.databinding.FragmentHotusersBinding
...
@AndroidEntryPoint
class HotUsersFragment:BasePersonFragment(R.layout.fragment_hotusers) {
    lateinit var binding:FragmentHotusersBinding
    ...
    override fun onCreateView(
        ...
        if(mRootView==null)
        {
            binding=DataBindingUtil.inflate(inflater,R.layout.fragment_hotusers,container,false)
